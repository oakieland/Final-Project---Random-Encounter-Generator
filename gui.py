...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.msg_error = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.msg_error.setStyleSheet("color: rgb(255, 0, 0);")
        self.msg_error.setText("")
        self.msg_error.setObjectName("msg_error")
        self.gridLayout_2.addWidget(self.msg_error, 2, 1, 1, 1)
